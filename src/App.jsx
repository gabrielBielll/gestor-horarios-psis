...
// O componente para injetar estilos globais
const GlobalStyles = () => {
    const styles = `
        ...
        * {
        ...
        .sidebar {
            ...
            padding: 2rem;
            border-right: 1px solid rgba(149, 160, 132, 0.2);
            display: flex;
        ...
        .sidebar-header {
            ...
            margin-bottom: 1rem;
            border-bottom: 1px solid rgba(149, 160, 132, 0.1);
        }
        .sidebar-title {
        ...
        .nav-link.active {
            background: linear-gradient(135deg, var(--sage-green) 0%, #8a9575 100%);
            color: var(--white);
            box-shadow: var(--shadow-soft);
        }
        ...
        .section-card {
            ...
            margin-bottom: 2rem;
            overflow: hidden;
            border: 1px solid rgba(149, 160, 132, 0.1);
        }
        .section-header {
            padding: 1.5rem 2rem;
            background: linear-gradient(135deg, var(--sage-green) 0%, #8a9575 100%);
        ...
        .schedule-card-content.expanded {
        ...
        .day-schedule {
            ...
            border-radius: var(--border-radius-small);
            padding: 1rem;
            border: 1px solid rgba(149, 160, 132, 0.2);
        }
        .day-name {
            font-weight: 600;
            color: var(--sage-green);
        ...
        .btn-secondary {
             background: linear-gradient(135deg, var(--warm-beige) 0%, #b5926d 100%);
             color: var(--white);
        }
        .btn-tertiary {
             background: linear-gradient(135deg, var(--terracotta) 0%, #c1734f 100%);
             color: var(--white);
        }
         .btn-ghost {
            background: transparent;
            color: var(--charcoal);
            border: 1px solid rgba(149, 160, 132, 0.3);
         }
         .btn-ghost:hover {
        ...
        .form-input {
            padding: 1rem;
            border: 2px solid rgba(149, 160, 132, 0.2);
            border-radius: var(--border-radius-small);
            font-family: var(--font-body);
            font-size: 1rem;
            transition: var(--transition);
        ...
        .form-input:focus {
            outline: none;
            border-color: var(--sage-green);
            box-shadow: 0 0 0 3px rgba(149, 160, 132, 0.1);
        }
        ...
        .checkbox-item:hover {
            background: rgba(149, 160, 132, 0.05);
        }
        .checkbox-input {
            width: 18px;
            height: 18px;
        ...
        .spinner {
            width: 40px;
            height: 40px;
            border: 3px solid rgba(149, 160, 132, 0.3);
        ...
        .notification-toast {
            ...
            gap: 1rem;
            z-index: 3000;
            animation: slideDown 0.5s cubic-bezier(0.4, 0, 0.2, 1) forwards, slideUp 0.5s cubic-bezier(0.4, 0, 0.2, 1) 2.5s forwards;
        }
        @keyframes slideDown {
        ...
        /* --- ESTILOS DAS FERRAMENTAS DE DEV --- */
        .json-viewer, .request-sender {
        ...
        @media (max-width: 1024px) {
            ...
            .sidebar { width: 100%; border-right: none; border-bottom: 1px solid rgba(149, 160, 132, 0.2); }
            .app-container { padding: 1.5rem; }
        }
        @media (max-width: 768px) {
            .section-content { padding: 1.5rem; }
            .schedule-grid { grid-template-columns: 1fr; }
             .time-selection-grid { grid-template-columns: repeat(auto-fit, minmax(120px, 1fr)); gap: 1rem; padding: 1.5rem; }
             .form-grid { grid-template-columns: 1fr; }
        }
        @media (max-width: 480px) {
            .app-title { font-size: 2.5rem; }
             .schedule-card-header { flex-direction: column; gap: 1rem; align-items: stretch; }
             .schedule-actions { justify-content: center; }
             .time-selection-grid { grid-template-columns: 1fr; }
              .total-schedule-grid { grid-template-columns: 1fr; }
        }
    `;
...
function App() {
    ...
    const handleCreateSubmit = useCallback(async (e) => {
        ...
        setHorariosPsicologos([...horariosPsicologos, { id: createId, nome: `Psicólogo ${createId}`, horarios: {} }]);
    }, [createId, createPassword, horariosPsicologos, showNotification]);
    ...
    const handleEditSubmit = useCallback(async (e) => {
        ...
        setHorariosPsicologos(horariosPsicologos.map(psi =>
            psi.id === editId ? { ...psi, nome: editPassword ? `Psicólogo ${editId}` : psi.nome, horarios: horariosSelecionados } : psi
        ));
    }, [editId, editPassword, horariosSelecionados, horariosPsicologos, showNotification]);
    ...
    const openEditModal = useCallback((psicologo) => {
        ...
        setEditPassword(''); // Password is not